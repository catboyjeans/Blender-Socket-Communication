...
Although this addon is compatible with any plataform that supports UDP/TCP protocols, this build specifically is most compatible with the [Matlab Socket Setup](MATLAB_SETUP.md)
